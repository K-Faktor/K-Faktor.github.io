...
(function ()
{
	...
	var SAMPLE = {
		allies: [["VaSYa_1972", 104, 19, 3, 10, 42], ["ak47", 103, 20, 1, 7, 73],
			["huracan", 81, 15, 2, 7, 32], ["K-Faktor", 79, 14, 2, 10, 24],
			["Wale", 34, 5, 1, 6, 38]],
		axis: [["FNRP-TpaB", 91, 17, 0, 15, 28], ["MOHOMAX", 38, 7, 1, 14, 28],
			["aLp*efrem", 36, 6, 1, 14, 21], ["001", 33, 6, 0, 14, 23],
			["Russia", 20, 4, 0, 16, 26]]
	};
	...
	var PRESETS = [
		...
		{ name: "Фиолетовый и жёлтый",
			...
			mine: "0.89 1 0.184 1" },
		{ name: "Красно-оранжевый и тёмно-синий",
	...
	var PRESET_PARTS = [
		{ key: "allies", label: "Строка союзников", dvars: ["g_ScoresColor_Allies"] },
		{ key: "axis", label: "Строка оси", dvars: ["g_ScoresColor_Axis"] },
		{ key: "mine", label: "Мой цвет", dvars: ["cg_scoreboardMyColor"] },
		{ key: "alliesTitle", label: "Заголовок союзников", dvars: ["g_TeamColor_Allies"] },
		{ key: "axisTitle", label: "Заголовок оси", dvars: ["g_TeamColor_Axis"] }
	];
	...
	var FIELDS = [
		{ group: "Команды", dvar: "g_TeamName_Allies", kind: "text", def: "^8ATTACK^7", label: "Имя союзников" },
		{ group: "Команды", dvar: "g_TeamName_Axis", kind: "text", def: "^9DEFENCE^7", label: "Имя оси" },
		{ group: "Команды", dvar: "g_ScoresColor_Allies", kind: "color", def: "0.847 0.992 0.576 1", label: "Строка союзников" },
		{ group: "Команды", dvar: "g_ScoresColor_Axis", kind: "color", def: "0.561 0.655 0.843 1", label: "Строка оси" },
		{ group: "Команды", dvar: "g_ScoresColor_Spectator", kind: "color", def: "1 0 0.2 0.5", label: "Строка наблюдателей" },
		{ group: "Команды", dvar: "g_ScoresColor_Free", kind: "color", def: "1 1 0.6 0.5", label: "Строка свободных" },
		{ group: "Команды", dvar: "cg_scoreboardMyColor", kind: "color", def: "0.3 0.3 0.3 1", label: "Ваш собственный текст" },
		{ group: "Команды", dvar: "g_TeamColor_Allies", kind: "color", def: "0.847 0.992 0.576 1", label: "Союзники ^8 / ^9" },
		{ group: "Команды", dvar: "g_TeamColor_Axis", kind: "color", def: "0.561 0.655 0.843 1", label: "Ось ^8 / ^9" },

		{ group: "Планировка", dvar: "cg_scoreboardWidth", kind: "num", def: 400, min: 200, max: 640, step: 5, label: "Ширина табло" },
		{ group: "Планировка", dvar: "cg_scoreboardHeight", kind: "num", def: 485, min: 200, max: 600, step: 5, label: "Высота табло" },
		{ group: "Планировка", dvar: "cg_scoreboardItemHeight", kind: "num", def: 15, min: 8, max: 40, step: 1, label: "Высота строки" },
		{ group: "Планировка", dvar: "cg_scoreboardBannerHeight", kind: "num", def: 25, min: 10, max: 60, step: 1, label: "Высота баннера" },
		{ group: "Планировка", dvar: "cg_scoreboardHeaderFontScale", kind: "num", def: 0.2, min: 0.1, max: 0.6, step: 0.01, label: "Масштаб шрифта заголовка" },
		{ group: "Планировка", dvar: "cg_scoreboardFont", kind: "num", def: 0, min: 0, max: 6, step: 1, label: "Шрифт табло" },
		{ group: "Планировка", dvar: "cg_scoreboardScrollStep", kind: "num", def: 3, min: 1, max: 8, step: 1, label: "Шаг прокрутки" },
		{ group: "Планировка", dvar: "cg_scoreboardTextOffset", kind: "num", def: 0.5, min: 0, max: 4, step: 0.1, label: "Смещение текста" },
		{ group: "Планировка", dvar: "cg_scoreboardRankFontScale", kind: "num", def: 0.1, min: 0, max: 1, step: 0.05, label: "Масштаб шрифта ранга" },

		{ group: "Пинг", dvar: "cg_scoreboardPingText", kind: "bool", def: 1, label: "Текст пинга" },
		{ group: "Пинг", dvar: "cg_scoreboardPingGraph", kind: "bool", def: 0, label: "График пинга" },
		{ group: "Пинг", dvar: "cg_ScoresPing_MaxBars", kind: "num", def: 5, min: 1, max: 10, step: 1, label: "Макс. полосок" },
		{ group: "Пинг", dvar: "cg_ScoresPing_Interval", kind: "num", def: 25, min: 1, max: 500, step: 1, label: "Интервал пинга" },
		{ group: "Пинг", dvar: "cg_scoreboardPingHeight", kind: "num", def: 0.7, min: 0.1, max: 1, step: 0.01, label: "Высота пинга" },
		{ group: "Пинг", dvar: "cg_scoreboardPingWidth", kind: "num", def: 0.036, min: 0.01, max: 0.2, step: 0.002, label: "Ширина пинга" },
		{ group: "Пинг", dvar: "cg_ScoresPing_HighColor", kind: "color", def: "0.8 0 0 1", label: "Высокий пинг" },
		{ group: "Пинг", dvar: "cg_ScoresPing_MedColor", kind: "color", def: "0.8 0.8 0 1", label: "Средний пинг" },
		{ group: "Пинг", dvar: "cg_ScoresPing_LowColor", kind: "color", def: "0 0.75 0 1", label: "Низкий пинг" },
		{ group: "Пинг", dvar: "cg_ScoresPing_BgColor", kind: "color", def: "0 0 0 0", label: "Фон пинга" }
	];
	...
	function makeControl(f)
	{
		...
		if (f.kind === "color")
		{
			...
			text.setAttribute("aria-label", f.dvar + " значение");
	...
	function init()
	{
		...
		if (reset !== null)
		{
			reset.addEventListener("click", function ()
			{
				...
				buildControls();
				update();
				setHint("Сброшено к значениям по умолчанию.");
			});
		}

		wireCopy("sb-copy-bind", outBind, "Строка бинда скопирована.");
		wireCopy("sb-copy-board", outBoard, "Строки табло скопированы.");
		wireCopy("sb-copy-teams", outTeams, "Строки команд скопированы.");
	}
